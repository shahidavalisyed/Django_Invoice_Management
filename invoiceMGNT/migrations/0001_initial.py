    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('line_one_unit_price', models.IntegerField(blank=True, default=6, null=True, verbose_name='Unit Price (D)')),
                ...
                ('line_two_quantity', models.IntegerField(blank=True, default=8, null=True, verbose_name='Quantity')),
                ('line_two_unit_price', models.IntegerField(blank=True, default=8, null=True, verbose_name='Unit Price (D)')),
                ...
                ('line_three_quantity', models.IntegerField(blank=True, default=8, null=True, verbose_name='Quantity')),
                ('line_three_unit_price', models.IntegerField(blank=True, default=8, null=True, verbose_name='Unit Price (D)')),
                ...
                ('invoice_type', models.CharField(blank=True, choices=[('Receipt', 'Receipt'), ('Proforma Invoice', 'Proforma Invoice'), ('Proforma Invoice', 'Proforma Invoice'), ('Invoice', 'Invoice')], default='', max_length=50, null=True)),
            ],
        ),
    ]
